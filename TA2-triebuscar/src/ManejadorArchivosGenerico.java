...
public class ManejadorArchivosGenerico {
	...
	public static String[] leerArchivo(String nombreCompletoArchivo){
		FileReader fr;
		URL urlArchivo = ManejadorArchivosGenerico.class.getResource(nombreCompletoArchivo);
		ArrayList<String> listaLineasArchivo = new ArrayList<String>();
		try {
			if (urlArchivo != null) {
				String path = URLDecoder.decode(urlArchivo.getPath(), "UTF-8");
				...
				System.out.println("Archivo no encontrado: " + nombreCompletoArchivo);
			}
